      ...
      <ul className="navbar-nav">
        ...
        <li className="nav-item">
          <Link to={"/home"} className="nav-link">
            ...
            <span className="link-text">Kezdőlap</span>
          </Link>
        </li>
        {authC.isLoggedIn && (
          <li className="nav-item">
            <Link to={"/newTeam"} className="nav-link">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="16"
                width="20"
              ...
              <span className="link-text">Új csapat felvétele</span>
            </Link>
          </li>
        )}
        <li className="nav-item">
          <Link to={"/matches"} className="nav-link">
            ...
            <span className="link-text">Mérkőzések</span>
          </Link>
        </li>
        <li className="nav-item">
          <Link to={"/tagok"} className="nav-link">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="16"
              width="20"
            ...
            <span className="link-text">Tagok listázása</span>
          </Link>
        </li>
        {authC.isLoggedIn && (
          <>
            <li className="nav-item">
              <Link to={"/home"} className="nav-link">
                ...
                <span className="link-text">Új mérkőzés felvétele</span>
              </Link>
            </li>
            <li className="nav-item">
              <Link to={"/ujTag"} className="nav-link">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="16"
                  width="20"
                ...
                <span className="link-text">Új tag felvétele</span>
              </Link>
            </li>
          </>
        )}
        {authC.isLoggedIn && (
          <li className="nav-item">
            ...
            >
              ...
              <span className="link-text">Kijelentkezés</span>
            </Link>
          </li>
        )}
        {!authC.isLoggedIn && (
          <li className="nav-item">
            <Link to={"/login"} className="nav-link">
              ...
              <span className="link-text">Bejelentkezés</span>
            </Link>
          </li>
        )}
      </ul>
